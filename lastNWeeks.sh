...
# PhD
venv/bin/python ./cli.py 1 8 $LAST_N_WEEKS "" 1
cp out/phd/csv/latest.csv out/phd.csv
# stasbar
venv/bin/python ./cli.py 2 8 $LAST_N_WEEKS "" 1
cp out/stasbar-sp-z-o-o/csv/latest.csv out/stasbar.csv
# Dancing
venv/bin/python ./cli.py 16 8 $LAST_N_WEEKS "" 1
...
# Self-investement
venv/bin/python ./cli.py 12 8 $LAST_N_WEEKS "" 1
cp out/self-investment/csv/latest.csv out/self-investment.csv
# Health
venv/bin/python ./cli.py 14 8 $LAST_N_WEEKS "" 1
